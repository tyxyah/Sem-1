...
/* their status and taxable income in order to compute the tax                       */
/* Course Name : Computer Programming I                                              */
/* Course Code : SSK3100 Group 3                                                     */
/* Assignment and Question Number : Assignment 2, Q5                                 */
...
public class ComputeTax {
	public static void main(String[] args) {
		...
		//prompts user to enter filing status
		...
		//this will be displayed if the users enter other status
		else {
